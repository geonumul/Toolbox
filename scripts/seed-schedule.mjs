...
const EVENTS = [
  ...
  { id: '2025-09-19-indesign-1',   date: '2025-09-19', title: 'InDesign 1회차',  description: 'Johnny Park 강의 4–8강 실습 및 Character Style 학습, D5 학생 인증 진행', time: FRI, location: D341 },
  { id: '2025-09-23-indesign-2',   date: '2025-09-23', title: 'InDesign 2회차',  description: '선배들의 포트폴리오 피드백 공유 및 1회차 과제 복습', time: TUE, location: D341 },
  { id: '2025-09-26-indesign-3',   date: '2025-09-26', title: 'InDesign 3회차',  description: '주요 CG 회사 소개 및 개인 이미지·프로젝트를 활용한 패널 레이아웃 구성', time: FRI, location: D341 },
  ...
  { id: '2025-10-24-indesign-4',   date: '2025-10-24', title: 'InDesign 4회차',  description: '중간고사 이후 InDesign 세션 재개', time: FRI, location: D341 },
  ...
  { id: '2025-11-06-d5-4',         date: '2025-11-06', title: 'D5 4회차',        description: '강환국 선배님 제공 모델링 렌더링 1차 및 상호 피드백', time: '', location: D208 },
  { id: '2025-11-11-d5-5',         date: '2025-11-11', title: 'D5 5회차',        description: '강환국 선배님 제공 모델링 렌더링 2차', time: TUE, location: D208 },
  { id: '2025-11-13-d5-6',         date: '2025-11-13', title: 'D5 6회차',        description: '강환국 선배님 제공 모델링 렌더링 3차 (마무리)', time: '', location: D208 },

  { id: '2025-11-17-dinner',       date: '2025-11-17', title: 'TOOLBOX 정기 회식', description: '한 학기 마무리 정기 회식', time: TUE, location: '맛닭꼬' },
  { id: '2025-11-20-indesign-5',   date: '2025-11-20', title: 'InDesign 5회차',  description: '개인 D5 결과물을 활용한 InDesign 레이아웃 작업', time: FRI, location: D208 },
  ...
  { id: '2026-01-12-revit-2',      date: '2026-01-12', title: 'Revit 2회차',     description: 'Notion 페이지 안내, 개인 프로젝트 주제 공유 및 사이트 자료 제작 강의', time: MON, location: MEET },
  { id: '2026-01-19-revit-3',      date: '2026-01-19', title: 'Revit 3회차',     description: '수치지형도 신청 및 변환, SketchUp 사이트 제작(Ruby) 강의, 매스 및 단선평면 학습', time: MON, location: MEET },
  { id: '2026-01-26-revit-4',      date: '2026-01-26', title: 'Revit 4회차',     description: '계획 재구성, 수치지형도 다운로드 및 SketchUp 사이트 모델링', time: MON, location: MEET },
  ...
  { id: '2026-03-09-portfolio',    date: '2026-03-09', title: '개인 프로젝트 크리틱',        description: 'Figma Make로 웹 포트폴리오 제작 및 소모임원 상호 개인 프로젝트 크리틱', time: MON, location: MEET },
  { id: '2026-03-16-project-pick', date: '2026-03-16', title: '프로젝트 방향 결정',         description: '프로젝트 방향 결정 및 Illustrator 영상 학습', time: MON, location: MEET },
  { id: '2026-03-23-illust-lisp',  date: '2026-03-23', title: 'Illustrator & AutoLISP', description: '유승민·박경준 Illustrator 사이트 다이어그램 강의 및 고건 AutoLISP 강의', time: MON, location: MEET },
  { id: '2026-03-30-web-portfolio',date: '2026-03-30', title: 'Figma 웹 포트폴리오',          description: 'Figma 토큰을 활용한 웹 포트폴리오 제작, 관리자 모드 포함 반응형 구현 목표', time: MON, location: MEET },
