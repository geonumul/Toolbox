...
const EVENTS = [
  // ──────────────── Fall 2025 (오프라인) ────────────────
  { id: '2025-09-16-indesign-ot',  date: '2025-09-16', title: 'TOOLBOX OT',      description: 'TOOLBOX 소모임 창립 첫 모임으로 운영 계획 및 정기모임 일정 공유 (화 19–21시 / 금 15–17시)', time: '19:00', location: D341 },
  ...
  { id: '2025-11-17-dinner',       date: '2025-11-17', title: 'TOOLBOX 정기 회식', description: '한 학기 마무리 정기 회식', time: '', location: '맛닭꼬' },
  ...
  { id: '2026-01-05-revit-1',      date: '2026-01-05', title: 'Revit 1회차',     description: '스터디 시작, Revit 2024 및 D5 for Revit 설치, 과제 안내', time: '', location: MEET },
  { id: '2026-01-12-revit-2',      date: '2026-01-12', title: 'Revit 2회차',     description: '노션 페이지 안내, 개인 프로젝트 주제 공유 및 사이트 자료 제작 강의', time: '', location: MEET },
  { id: '2026-01-19-revit-3',      date: '2026-01-19', title: 'Revit 3회차',     description: '수치지형도 신청 및 변환, 스케치업 사이트 제작(루비) 강의, 매스 및 단선평면 학습', time: '', location: MEET },
  { id: '2026-01-26-revit-4',      date: '2026-01-26', title: 'Revit 4회차',     description: '계획 재구성, 수치지형도 다운로드 및 스케치업 사이트 모델링', time: '', location: MEET },
  { id: '2026-02-02-revit-5',      date: '2026-02-02', title: 'Revit 5회차',     description: '신입생 모집 시기 논의 및 매스스터디 강의·실습', time: '', location: MEET },
  { id: '2026-02-09-revit-6',      date: '2026-02-09', title: 'Revit 6회차',     description: '사이트 매핑(도로·횡단보도) 및 박경준 강의 후 개인 실습', time: '', location: MEET },
  ...
  { id: '2026-03-02-revit-9',      date: '2026-03-02', title: 'Revit 9회차',     description: '진행 상황 공유 및 방향성 논의 (과제 없이 자유 참여)', time: '', location: MEET },

  { id: '2026-03-09-portfolio',    date: '2026-03-09', title: '포트폴리오 크리틱',          description: '피그마 메이크를 활용한 포트폴리오 제작 및 개인 프로젝트 오픈 크리틱', time: '', location: MEET },
  { id: '2026-03-16-project-pick', date: '2026-03-16', title: '프로젝트 방향 결정',         description: '프로젝트 방향 결정, 일러스트레이터 영상 학습 및 개인 크리틱', time: '', location: MEET },
  { id: '2026-03-23-illust-lisp',  date: '2026-03-23', title: '일러스트레이터 & 캐드 리습', description: '유승민·박경준 일러스트레이터 사이트 다이어그램 강의 및 고건 캐드 리습 강의', time: '', location: MEET },
  { id: '2026-03-30-web-portfolio',date: '2026-03-30', title: '피그마 웹 포트폴리오',        description: '피그마 토큰을 활용한 웹 포트폴리오 제작, 관리자 모드 포함 반응형 구현 목표', time: '', location: MEET },
  ...
  { id: '2026-05-04-offline',      date: '2026-05-04', title: '대면 모임', description: '대면 모임 (세부 내용 미정)', time: '', location: D208 },
];
